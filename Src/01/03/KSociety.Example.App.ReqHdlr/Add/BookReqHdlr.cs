...
using KSociety.Example.App.Dto.Req.Add;
using KSociety.Example.Domain.Repository;
using Microsoft.Extensions.Logging;

namespace KSociety.Example.App.ReqHdlr.Add
{
    public class BookReqHdlr : IRequestHandlerWithResponseAsync<Book, KSociety.Example.App.Dto.Res.Add.Book>
    {
        ...
        public async ValueTask<KSociety.Example.App.Dto.Res.Add.Book> ExecuteAsync(Book request, CancellationToken cancellationToken = default)
        {
            ...
            return result == -1 ? new KSociety.Example.App.Dto.Res.Add.Book(Guid.Empty) : new KSociety.Example.App.Dto.Res.Add.Book(book.Id);
        }
    }
}
