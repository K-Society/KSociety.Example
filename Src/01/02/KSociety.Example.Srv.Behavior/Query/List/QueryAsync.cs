...
using KSociety.Example.Srv.Contract.Query.List;
using Microsoft.Extensions.Logging;
using ProtoBuf.Grpc;

namespace KSociety.Example.Srv.Behavior.Query.List
{
    public class QueryAsync : IQueryAsync
    {
        ...
        public async ValueTask<Srv.Dto.List.Book> BookAsync(CallContext context = default)
        {
            ...
            var output = new Srv.Dto.List.Book(bookItems);
